const PrivacyPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto space-y-3">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Our Planet Earth.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Our Planet Earth, accessible from{' '}
            <a href="https://ourplanetearth.eco" rel="external nofollow noopener" target="_blank">
              https://ourplanetearth.eco
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: ourplanetearth.eco@gmail.com</li>
      </ul>
    </div>
  )
}
